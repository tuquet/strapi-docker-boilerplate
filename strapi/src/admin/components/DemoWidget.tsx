...
const DemoWidget = () => {
  return (
    <Box padding={4} background="neutral0" borderColor="neutral150" hasRadius>
        ...
        <Box style={{ flex: '1 1 45%' }}>
          <Flex direction="column" alignItems="flex-start" gap={2}>
            ...
            <Typography variant="omega" textColor="neutral600">
              Experience Strapi in a production-like setup. Explore the platform
              as a real team would use it.
            </Typography>
            <Typography variant="omega" textColor="neutral600">
              <strong>All paid features are unlocked</strong> in this demo so
              you can explore the full capabilities of Strapi.
            </Typography>
          </Flex>
        </Box>
        ...
        <Box style={{ flex: '1 1 55%' }}>
          <Flex direction="column" alignItems="flex-start" gap={5}>
            <Flex direction="column" alignItems="flex-start" gap={3}>
              ...
              <Flex gap={2} wrap="wrap">
                <LinkButton
                  ...
                  variant="secondary"
                  startIcon={<Database fill="primary600" />}
                >
                  Content Manager
                </LinkButton>
                <LinkButton
                  ...
                  variant="secondary"
                  startIcon={<ImageIcon fill="primary600" />}
                >
                  Media Library
                </LinkButton>
                <LinkButton
                  ...
                  variant="secondary"
                  startIcon={<Globe fill="primary600" />}
                >
            ...
            <Flex direction="column" alignItems="flex-start" gap={3}>
              ...
              <Flex gap={2} wrap="wrap">
                <LinkButton
                  href="/admin/plugins/content-releases"
                  variant="secondary"
                  startIcon={<Rocket fill="primary600" />}
                >
                  Releases
                </LinkButton>
                <LinkButton
                  href="/admin/settings/review-workflows"
                  variant="secondary"
                  startIcon={<ManyWays fill="primary600" />}
                >
                  Review Workflows
                </LinkButton>
                <LinkButton
                  ...
                  variant="secondary"
                  startIcon={<Shield fill="primary600" />}
                >
                  Audit Logs
                </LinkButton>
              </Flex>
      ...
      <Box marginTop={6} padding={4} borderColor="neutral150">
        <Flex gap={3}>
